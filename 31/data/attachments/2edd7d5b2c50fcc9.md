...
- Name: search.spec.ts >> Search Tests >> SEA-002 - There should NOT be any item listed if user search for a non-existing product
- Location: tests/search.spec.ts:21:9
