...
- Name: register.spec.ts >> Register Tests >> Account Creation Mandatory Fields >> REG-004 - User should not be able to register successfully when password is missing
